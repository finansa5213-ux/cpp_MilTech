...
public:
    ...
    explicit MavlinkLink(ITransport& transport,
                         std::uint8_t sysid = kDefaultSysId,
                         std::uint8_t compid = kDefaultCompId);
    ...
    bool dropFinished() const noexcept {
        return drop_state_ == DropState::Acked || drop_state_ == DropState::Failed;
    }
